...
highScoreElement.innerHTML = `Hihg Score: ${highScore}`;

// Pass a randomw between 1 and 30 as food position
...
const initGame = () => {
  ...
  if (snakeX === foodX && snakeY === foodY) {
    ...
    score++;
    highScore = score >= highScore ? score : highScore; // if socre > high socre => high score = score
